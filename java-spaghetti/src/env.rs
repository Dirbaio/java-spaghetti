...
impl<'env> Env<'env> {
    ...
    unsafe fn exception_to_string(self, exception: jobject) -> String {
        ...
        let throwable_get_message = *METHOD_GET_MESSAGE.get_or_init(|| {
            ...
            let throwable_class = self.require_class_jni("java/lang/Throwable\0").unwrap();
            self.require_method(&throwable_class, "getMessage\0", "()Ljava/lang/String;\0")
        });
    ...
    pub unsafe fn require_class(self, class: &str) -> JClass {
        ...
        if !classloader.is_null() {
            ...
            let cl_method = CL_METHOD.get_or_init(|| {
                ...
                let cl_class = self.require_class_jni("java/lang/ClassLoader\0").unwrap();
                self.require_method(&cl_class, "loadClass\0", "(Ljava/lang/String;)Ljava/lang/Class;\0")
            });
            ...
            return JClass::from_raw(self, result);
        }
    ...
    pub unsafe fn get_static_boolean_field(self, class: &JClass, field: JFieldID) -> bool {
        let result = ((**self.env).v1_2.GetStaticBooleanField)(self.env, class.as_raw(), field.as_raw());
        result != JNI_FALSE
    }

    pub unsafe fn get_static_byte_field(self, class: &JClass, field: JFieldID) -> jbyte {
        ((**self.env).v1_2.GetStaticByteField)(self.env, class.as_raw(), field.as_raw())
    }

    pub unsafe fn get_static_char_field(self, class: &JClass, field: JFieldID) -> jchar {
        ((**self.env).v1_2.GetStaticCharField)(self.env, class.as_raw(), field.as_raw())
    }

    pub unsafe fn get_static_short_field(self, class: &JClass, field: JFieldID) -> jshort {
        ((**self.env).v1_2.GetStaticShortField)(self.env, class.as_raw(), field.as_raw())
    }

    pub unsafe fn get_static_int_field(self, class: &JClass, field: JFieldID) -> jint {
        ((**self.env).v1_2.GetStaticIntField)(self.env, class.as_raw(), field.as_raw())
    }

    pub unsafe fn get_static_long_field(self, class: &JClass, field: JFieldID) -> jlong {
        ((**self.env).v1_2.GetStaticLongField)(self.env, class.as_raw(), field.as_raw())
    }

    pub unsafe fn get_static_float_field(self, class: &JClass, field: JFieldID) -> jfloat {
        ((**self.env).v1_2.GetStaticFloatField)(self.env, class.as_raw(), field.as_raw())
    }

    pub unsafe fn get_static_double_field(self, class: &JClass, field: JFieldID) -> jdouble {
        ((**self.env).v1_2.GetStaticDoubleField)(self.env, class.as_raw(), field.as_raw())
    }
    ...
    pub unsafe fn set_static_byte_field(self, class: &JClass, field: JFieldID, value: jbyte) {
        ((**self.env).v1_2.SetStaticByteField)(self.env, class.as_raw(), field.as_raw(), value);
    }

    pub unsafe fn set_static_char_field(self, class: &JClass, field: JFieldID, value: jchar) {
        ((**self.env).v1_2.SetStaticCharField)(self.env, class.as_raw(), field.as_raw(), value);
    }

    pub unsafe fn set_static_short_field(self, class: &JClass, field: JFieldID, value: jshort) {
        ((**self.env).v1_2.SetStaticShortField)(self.env, class.as_raw(), field.as_raw(), value);
    }

    pub unsafe fn set_static_int_field(self, class: &JClass, field: JFieldID, value: jint) {
        ((**self.env).v1_2.SetStaticIntField)(self.env, class.as_raw(), field.as_raw(), value);
    }

    pub unsafe fn set_static_long_field(self, class: &JClass, field: JFieldID, value: jlong) {
        ((**self.env).v1_2.SetStaticLongField)(self.env, class.as_raw(), field.as_raw(), value);
    }

    pub unsafe fn set_static_float_field(self, class: &JClass, field: JFieldID, value: jfloat) {
        ((**self.env).v1_2.SetStaticFloatField)(self.env, class.as_raw(), field.as_raw(), value);
    }

    pub unsafe fn set_static_double_field(self, class: &JClass, field: JFieldID, value: jdouble) {
        ((**self.env).v1_2.SetStaticDoubleField)(self.env, class.as_raw(), field.as_raw(), value);
    }
